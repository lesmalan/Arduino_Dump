...
unsigned long EpreviousMillis = 0; // Stores the last time a reading was taken for Elevation motor
unsigned long ApreviousMillis = 0; // Stores the last time a reading was taken
const long interval = 100;       // Interval at which to read sensor data (e.g., 100ms)
const long interval2 = 5000;       // Interval at which to do sweep
