...
/* Order of delclaration matters so make sure to have POS BEFORE the pointer */ 
int *new_pos = &pos; // new_pos points to memory address ofint *new_pos = NULL; // new_pos points to memory address NULL 
